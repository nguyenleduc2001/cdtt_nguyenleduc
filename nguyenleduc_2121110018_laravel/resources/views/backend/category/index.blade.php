          ...
          <tbody>
            @foreach ($list as $row)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('category.show',['category' => $row ->id]) }}" class="btn btn-sm btn-success">
                      <i class="fas fa-toggle-on"></i></a>
                    <a href="{{ route('category.edit',['category' => $row ->id]) }}" class="btn btn-sm btn-info" > <i class="fas fa-wrench"></i></a>
                    <a href="{{ route('category.show',['category' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="far fa-eye"></i></a>
                    <a href="{{ route('category.trash',['category' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="fas fa-trash"></i></a>
                  </td>
                  <td>{{ $row->id }}</td>
                </tr>
            @endforeach
