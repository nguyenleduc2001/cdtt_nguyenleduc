        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col text-right">
              ...
              <a href="{{ route('user.create') }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>Thùng rác</a>
            ...
            <tbody>
              @foreach ($list as $row)
                  <tr>
                    ...
                    <td><a href="{{ route('user.show',['user' => $row ->id]) }}" class="btn btn-sm btn-success">
                      <i class="fas fa-toggle-on"></i></a>
                    <a href="{{ route('user.edit',['user' => $row ->id]) }}" class="btn btn-sm btn-info" > <i class="fas fa-wrench"></i></a>
                    <a href="{{ route('user.show',['user' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="far fa-eye"></i></a>
                    <a href="{{ route('user.trash',['user' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="fas fa-trash"></i></a>
                    </td>
                    <td>{{ $row->id }}</td>
                  </tr>
              @endforeach</tbody>
