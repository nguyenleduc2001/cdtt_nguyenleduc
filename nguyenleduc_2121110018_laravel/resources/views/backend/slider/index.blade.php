              ...
              @foreach ($list as $row)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('slider.edit',['slider' => $row ->id]) }}" class="btn btn-sm btn-info" > <i class="fas fa-wrench"></i></a>
                      <a href="{{ route('slider.show',['slider' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="far fa-eye"></i></a>
                      <a href="{{ route('slider.trash',['slider' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="fas fa-trash"></i></a>
                    </td>
                    <td>{{ $row->id }}</td>
                  </tr>
              @endforeach</tbody>
