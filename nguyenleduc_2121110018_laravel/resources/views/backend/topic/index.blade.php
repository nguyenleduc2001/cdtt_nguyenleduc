            ...
            <tbody>
              @foreach ($list as $row)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('topic.show',['topic' => $row ->id]) }}" class="btn btn-sm btn-success">
                        <i class="fas fa-toggle-on"></i></a>
                      <a href="{{ route('topic.edit',['topic' => $row ->id]) }}" class="btn btn-sm btn-info" > <i class="fas fa-wrench"></i></a>
                      <a href="{{ route('topic.show',['topic' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="far fa-eye"></i></a>
                      <a href="{{ route('topic.trash',['topic' => $row ->id]) }}" class="btn btn-sm btn-danger "><i class="fas fa-trash"></i></a>
                      </td>
                    <td>{{ $row->id }}</td>
                  </tr>
              @endforeach</tbody>
